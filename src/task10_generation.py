...
# Model free trên OpenRouter — không tốn credit, phù hợp cho bài lab.
LLM_MODEL = "inclusionai/ling-3.0-flash:free"

# Model dùng khi fallback sang OPENAI_API_KEY thật (không phải OpenRouter key)
...
def call_llm(user_message: str) -> str:
    """
    Gọi LLM với SYSTEM_PROMPT chuẩn của Task 10. Tách riêng để dùng lại được
    ở nơi khác (vd: script eval so sánh config) mà không lặp lại logic chọn
    provider (OpenRouter vs OpenAI thật).
    """
